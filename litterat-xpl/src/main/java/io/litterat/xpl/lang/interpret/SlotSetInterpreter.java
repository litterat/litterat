...
public class SlotSetInterpreter implements StatementInterpreter {

	private final SlotSet slotSet;
	private final ExpressionInterpreter expression;

	public SlotSetInterpreter(SlotSet slotSet, ExpressionInterpreter expression) {
	...
	public Object execute(LitteratMachine am) throws Throwable {
		am.setVariable(slotSet.variable(), expression.execute(am));
		return null;
	}
}
