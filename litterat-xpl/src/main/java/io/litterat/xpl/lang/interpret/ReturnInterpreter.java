...
public class ReturnInterpreter implements StatementInterpreter {

	@SuppressWarnings("unused")
	private final ReturnNode retrn;
	private final ExpressionInterpreter expression;

	public ReturnInterpreter(ReturnNode retrn, ExpressionInterpreter expression) {
		this.retrn = retrn;
