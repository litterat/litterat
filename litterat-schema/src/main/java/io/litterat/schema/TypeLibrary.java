...
public class TypeLibrary {
	...
	/**
	 * This is here because Java has multiple classes which are represented in the
	 * schema using the same Java class. This allows mapping the class e.g.
	 * float.class and Float.class to TypeLibrary.FLOAT
	 *
	 * @param typeName
	 * @param clss
	 */
