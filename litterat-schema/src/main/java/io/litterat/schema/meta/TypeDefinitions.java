...
import io.litterat.schema.types.Atom;
import io.litterat.schema.types.AtomAttribute;
import io.litterat.schema.types.AtomAttribute.AtomBigEndian;
import io.litterat.schema.types.AtomAttribute.AtomFixedLength;
import io.litterat.schema.types.AtomAttribute.AtomIEEE756;
import io.litterat.schema.types.AtomAttribute.AtomInteger;
import io.litterat.schema.types.AtomAttribute.AtomLittleEndian;
import io.litterat.schema.types.AtomAttribute.AtomSigned;
import io.litterat.schema.types.AtomAttribute.AtomUnsigned;
import io.litterat.schema.types.AtomAttribute.AtomVariableLength;
import io.litterat.schema.types.Definition;
import io.litterat.schema.types.Encoding;
