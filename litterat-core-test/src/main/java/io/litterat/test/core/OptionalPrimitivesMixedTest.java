...
import io.litterat.test.core.data.OptionalPrimitivesMixed;
...
public class OptionalPrimitivesMixedTest {
	...
	public void checkDescriptor() throws Throwable {
        ...
        Assertions.assertFalse(intField.isRequired());
        ...
        Assertions.assertFalse(longField.isRequired());
        ...
        Assertions.assertFalse(doubleField.isRequired());
	...
	public void test1ToArray() throws Throwable {
        ...
        Assertions.assertInstanceOf(OptionalPrimitivesMixed.class, object);
