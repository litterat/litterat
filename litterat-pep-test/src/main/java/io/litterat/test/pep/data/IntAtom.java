...
/**
 * This tests the concept of an immutable atom. The constructor uses a static method to return
 * the value from a known set of objects. This might be useful where deserialization might
 * generate a lot of duplicate objects and put pressure on the garbage collector.
 *
 */
