...
import io.litterat.test.pep.data.SimpleImmutableDataOrder;
...
public class SimpleImmutableDataOrderTest {
	...
	public void checkDescriptor() throws Throwable {
		...
		PepDataClass descriptor = context.getDescriptor(SimpleImmutableDataOrder.class);
